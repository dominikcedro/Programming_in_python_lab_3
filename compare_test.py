...
from compare import parser_compare, turn_text_to_list, turn_to_shingles, jaccard
import pytest
import sys
...
def test_remove_punctuation_typical():
    ...
    query = "!1?2.3,4!5"
    target = "12345"
    # I couldn't force function to accept manual argument
...
def test_turn_to_shingles_typical():
    ...
    args = mock.Mock()
    args.k = 2
    assert turn_to_shingles(query, target, args) == (
        {'I am': 1, 'am a': 1, 'a student': 1}, {'I was': 1, 'was a': 1, 'a student': 1})
